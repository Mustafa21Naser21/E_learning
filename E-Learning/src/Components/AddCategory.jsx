  ...
  return (
    ...
    <section className="">
        ...
        <div className="add-category-admin mt-20 mb-60 relative">
            ...
            <button onClick={addCategory}  className="w-60 h-14  mb-10 mt-10 bg-header border-2 border-gray-400 text-white text-4xl px-4 py-2 rounded-lg"> <Link to='/categoryadmin'>اضافة فئة</Link><i className="fa-solid fa-check  border-2 border-white w-8 h-8 rounded-full text-xl "></i></button>
            </div>
