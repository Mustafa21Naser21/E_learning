...
export default function CategoryContentAdmin() {
     ...
     <section>
        ...
        <div className="category-content  relative">
            ...
            <div className='flex justify-center mt-20'>
                <button className='w-40 h-16 px-6 py-2  bg-header text-white text-3xl  rounded-lg'> <Link to='/addterm'>اضافة بند</Link></button>
                </div>
