    ...
    <header>
        ...
        <i className="fa-solid fa-pen"/>
          ...
          <div className="mt-10 flex justify-around">   
            ...
            <button onClick={showUser} className="w-32 h-12 bg-header  p-2 text-center text-white rounded-md hover:opacity-90 transition-opacity" >اضافة مستخدم جديد</button>
        ...
        <i className="fa-solid fa-pen"/>
          ...
          <input id="addCategory" placeholder="الاسم الاول" style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 p-4 mt-10 border border-input outline-slate-400 rounded-lg" type="text" />
          <select  id="addCategory" placeholder="الصفة"  style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 px-4 mt-10 border  border-input text-gray-400 outline-slate-400 rounded-lg">
            <option value="مشرف">مشرف</option>
            <option value="محرر">محرر</option>
            <option value="مستخدم">مستخدم</option>
          </select>
          <input id="addCategory" placeholder=" الاسم الاخير" style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 p-4 mt-8 border border-input outline-slate-400 rounded-lg" type="text" />
          <input id="addCategory" placeholder="  كلمة السر" style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 p-4 mt-8 border border-input outline-slate-400 rounded-lg" type="text" />
          <input id="addCategory" placeholder=" اسم المستخدم"  style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 p-4 mt-8 border  border-input outline-slate-400 rounded-lg" type="text" />
          <input id="addCategory" placeholder="   تأكيد كلمة السر" style={{width:'80%',marginLeft:'10%',marginRight:'10%'}} name="" className="w-72 h-12 p-4 mt-8 border border-input outline-slate-400 rounded-lg" type="text" />

          <button style={{marginRight:'80%'}} className="w-32 h-12 bg-header mt-12  p-2 text-center text-white rounded-md hover:opacity-90 transition-opacity" >اضافة مستخدم جديد</button>
