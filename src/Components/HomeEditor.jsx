  ...
  return (
    ...
    <section>
        ...
        <div className="flex justify-center mt-10">
            <button  className="btn-add w-40 h-16 px-6 py-2 mb-10 bg-header text-white text-3xl  rounded-lg"> <Link to='/addcategoryeditor'>اضافة فئة</Link></button>
        ...
        <div className="add-category mt-4   flex justify-between ">
            ...
            <div className="add-left w-72 h-20 bg-greenYellow mt-6 rounded-3xl mr-12 relative add1">
                <h2 className="text-white text-center text-xl pt-4"><i onClick={deleteCategory} className="fa-solid fa-trash delete-icon"></i> <Link to='/categorytitleEditor'>الفئة الاولى</Link><i className="fa-solid fa-pen-to-square modify-icon"></i></h2>
            </div>
