...
export default function CategoryContentViewer() {
  return (
   ...
   <div className="category-content">
       ...
       <div className="category-title mt-10">
           <div className="  mt-10 px-10">
               ...
               <h1  className="text-2xl h-auto mt-4 ">التعليمية بتوفير
اسس واجراءات
واضحة للتعلم
ا</h1>
           </div>
...
<h2 className='text-center text-white mt-6 h-44 text-xl px-2'> <Link to='/termcontent'>اسس واجراءات
واضحة للتعلم
الالكتروني</Link> 
